...
import type { ExpenseRecord, IncomeRecord } from '../services/monthly';
                    ...
                    >
                      <td className="px-4 sm:px-6 py-4">
                        <div className="flex items-center gap-3">
                          <span className="w-8 h-8 flex items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 flex-shrink-0"><AppIcon name={record.income_sources?.icon || 'banknote'} className="w-4 h-4" /></span>
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      <span className="w-10 h-10 flex items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 flex-shrink-0"><AppIcon name={record.income_sources?.icon || 'banknote'} className="w-5 h-5" /></span>
                  ...
                  return (
                    <Fragment key={record.id}>
                      ...
                      >
                        <td className="px-4 sm:px-6 py-4">
                          <div className="flex items-center gap-3">
                            <span className="w-8 h-8 flex items-center justify-center rounded-lg bg-rose-50 text-rose-600 flex-shrink-0"><AppIcon name={record.expense_categories?.icon || 'shopping-cart'} className="w-4 h-4" /></span>
            ...
            {expenseRecords.map((record) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      <span className="w-10 h-10 flex items-center justify-center rounded-xl bg-rose-50 text-rose-600 flex-shrink-0"><AppIcon name={record.expense_categories?.icon || 'shopping-cart'} className="w-5 h-5" /></span>
                      <div className="flex-1 min-w-0">
